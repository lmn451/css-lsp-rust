...
/// Origin of a CSS variable definition.
#[derive(Debug, Clone, Copy, Default, PartialEq, Eq, Serialize, Deserialize)]
pub enum CssVariableSource {
    /// A declaration parsed from CSS or a CSS-like source.
    #[default]
    Css,
    /// A synthetic global definition generated by Astro's font configuration.
    AstroFont,
    /// A declaration injected by Vite's SCSS `additionalData` option.
    ViteScssAdditionalData,
}

impl CssVariableSource {
    /// User-facing provenance for generated or injected definitions.
    pub fn label(self) -> Option<&'static str> {
        match self {
            Self::Css => None,
            Self::AstroFont => Some("Astro font configuration"),
            Self::ViteScssAdditionalData => Some("Vite SCSS additionalData"),
        }
    }
}
...
pub struct CssVariable {
    ...
    /// Provenance for configuration-generated or ordinary CSS definitions.
    #[serde(default)]
